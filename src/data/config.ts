export const SITE_CONFIG = {
  ...
  QUIZ_BANK: [
    { q: "我目前就读于哪所大学＀, options: ["武汉大学", "华中科技大学", "哈尔滨工业大孀, "清华大学"], a: 1 },
    { q: "我的MBTI人格是？", options: ["INTP", "ENFP", "ISTJ", "ENTJ"], a: 1 },
    { q: "我的家乡在哪里？", options: ["北京", "武汉", "哈尔滀, "上海"], a: 2 },
    { q: "我的格言是？", options: ["不问前程，尽管繁荀, "好好学习，天天向一, "我要成为海贼玀, "为中华之崛起"], a: 0 },
  ],
  TRUTH_BANK: [
    "#真心诀 对未来的迷茫",
    "#提问# 摄影用的什么设备？",
  ...
  POLL_OPS: ["更喜欢摄彀, "更喜欢文竀, "更喜欢Vlog", "我是来看脸的"],
  FORTUNE_BANK: [
