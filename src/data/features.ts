...
export const notesData: FeatureItem[] = [
  {
    ...
    color: "text-red-400",
    children: [
      { type: "file", name: "系统解剖孀, url: "#", icon: "fa-user-md" },
      { type: "file", name: "病理生理", url: "#", icon: "fa-stethoscope" },
      { type: "file", name: "药理学笔讀, url: "#", icon: "fa-medkit" },
    ],
  },
  {
    type: "folder",
  ...
  },
  {
    ...
    color: "text-blue-400",
    children: [
      { type: "file", name: "微积分·积分可视化", url: "/tools/微积分·积分方法可视化学习系统.html", icon: "fa-area-chart", slug: "calculus-viz", description: "微积分积分方法的交互式可视化学习工具，支持多种积分方法的动态演示　, tags: ["数学", "可视匀] },
      { type: "file", name: "高等数学", url: "#", icon: "fa-superscript" },
      { type: "file", name: "线性代敀, url: "#", icon: "fa-th" },
  ...
  },
  {
    ...
    children: [
      ...
      { type: "file", name: "语法长难叀, url: "#", icon: "fa-pencil" },
  ...
  },
  {
    ...
    children: [
      ...
      { type: "file", name: "服务器指什, url: "#", icon: "fa-terminal" },
    ],
  },
];
...
export const memoryData: FeatureItem[] = [
  {
    ...
    color: "text-amber-300",
    children: [
      { type: "file", name: "高中时代：走廊里的黄昀, url: "#", icon: "fa-sun-o" },
      { type: "file", name: "高三那年：夜灯与试卷", url: "#", icon: "fa-file-text-o" },
      { type: "file", name: "大一初见：初到校园的那一夀, url: "#", icon: "fa-university" },
      { type: "file", name: "第一次社团活动：紧张又开忀, url: "#", icon: "fa-users" },
  ...
  },
  {
    ...
    children: [
      ...
      { type: "file", name: "读书伀· 一起翻过的书页", url: "#", icon: "fa-book" },
      { type: "file", name: "社团招新 · 摊位后的故事", url: "#", icon: "fa-handshake-o" },
      { type: "file", name: "期末告别 · 考完那天的合彀, url: "#", icon: "fa-camera" },
    ],
  },
  {
    type: "folder",
    ...
    children: [
      ...
      { type: "file", name: "窗外鸟鸣：清晨的第一声问倀, url: "#", icon: "fa-music" },
      { type: "file", name: "雨后天空：被冲洗过的亀, url: "#", icon: "fa-cloud" },
      { type: "file", name: "路边花草：不经意瞥见的颜艀, url: "#", icon: "fa-leaf" },
    ],
  },
  {
    type: "folder",
    ...
    children: [
      ...
      { type: "file", name: "秋日银杏：满地金黄的校园跀, url: "#", icon: "fa-tree" },
      { type: "file", name: "跨年夜：零点前后的心愀, url: "#", icon: "fa-hourglass-half" },
    ],
  },
  {
    type: "folder",
    ...
    children: [
      ...
      { type: "file", name: "食堂限定：永远排长队的窗叀, url: "#", icon: "fa-spoon" },
...
export const shareData: FeatureItem[] = [
  {
    ...
    color: "text-sky-300",
    children: [
      { type: "file", name: "三体可视化人物介绀, url: "/tools/三体可视化人物介绀html", icon: "fa-globe", slug: "santi-characters", description: "《三体》系列小说主要角色的可视化介绍与关系图谱　, tags: ["三体", "可视匀] },
      { type: "file", name: "三体可视化语彀, url: "/tools/三体可视化语彀html", icon: "fa-quote-left", slug: "santi-quotes", description: "《三体》经典语录的视觉化呈现与交互浏览　, tags: ["三体", "语录"] },
      { type: "file", name: "个人主页主题（自什plus＀, url: "#", icon: "fa-html5" },
      { type: "file", name: "前端小组件集合（导航栀</ 卡片＀, url: "#", icon: "fa-puzzle-piece" },
      { type: "file", name: "学习可视化工兀Demo", url: "#", icon: "fa-bar-chart" },
  ...
  },
  {
    ...
    color: "text-emerald-300",
    children: [
      { type: "file", name: "批量重命吀</ 整理资料脚本", url: "#", icon: "fa-cog" },
      { type: "file", name: "爬取公开数据的小工具", url: "#", icon: "fa-bug" },
      { type: "file", name: "Markdown 轀HTML 渲染工具", url: "#", icon: "fa-file-code-o" },
  ...
  },
  {
    ...
    children: [
      ...
      { type: "file", name: "隐私与数据使用的思耀, url: "#", icon: "fa-user-secret" },
    ],
  },
  {
    type: "folder",
    ...
    children: [
      { type: "file", name: "想做但还没开始的小项盀, url: "#", icon: "fa-rocket" },
      { type: "file", name: "适合开源的课程 / 活动点子", url: "#", icon: "fa-university" },
      { type: "file", name: "“把自己用到爽”为目标的工具设惀, url: "#", icon: "fa-smile-o" },
      { type: "file", name: "和朋友一起做皀Side Project 列表", url: "#", icon: "fa-users" },
    ],
  },
];
...
export const revelationData: FeatureItem[] = [
  {
    ...
    color: "text-emerald-300",
    children: [
      { type: "file", name: "书籍体验-自伤自恋精神分析", url: "/tools/书籍体验-自伤自恋的精神分枀html", icon: "fa-book", slug: "book-narcissism", description: "《自伤自恋的精神分析》的沉浸式阅读体验页面　, tags: ["书籍", "心理孀] },
      { type: "file", name: "生命的韧性与成长", icon: "fa-seedling", url: "#" },
      { type: "file", name: "在不确定中寻找确宀, icon: "fa-compass", url: "#" },
    ],
  },
  {
    type: "folder",
    ...
    color: "text-yellow-300",
    children: [
      { type: "file", name: "长期主义学习泀, icon: "fa-clock-o", url: "#" },
  ...
  },
  {
    ...
    color: "text-cyan-300",
    children: [
      { type: "file", name: "技术与人文的交叀, icon: "fa-code", url: "#" },
      { type: "file", name: "共建、共享、开源协佀, icon: "fa-users", url: "#" },
    ],
  },
];
...
export const appsData: FeatureItem[] = [
  {
    ...
    children: [
      ...
      { type: "file", name: "Obsidian 知识庀, url: "#", icon: "fa-database" },
    ],
  },
  {
    type: "folder",
    ...
    color: "text-rose-300",
    children: [
      { type: "file", name: "每日日记最, url: "#", icon: "fa-book" },
      { type: "file", name: "读书卡片模版", url: "#", icon: "fa-id-card" },
      { type: "file", name: "Markdown 编辑噀, url: "#", icon: "fa-file-code-o" },
    ],
  },
  {
    type: "folder",
    ...
    color: "text-emerald-300",
    children: [
      { type: "file", name: "VS Code 启动噀, url: "#", icon: "fa-file-code-o" },
  ...
  },
  {
    ...
    color: "text-yellow-300",
    children: [
      { type: "file", name: "音乐播放噀, url: "#", icon: "fa-music" },
      { type: "file", name: "播客 / B 站收藀, url: "#", icon: "fa-youtube-play" },
  ...
  },
  {
    ...
    color: "text-sky-300",
    children: [
      { type: "file", name: "MyGPA 计算噀, url: "app://mygpa", icon: "fa-graduation-cap", slug: "mygpa", description: "GPA 计算与学期成绩管理工具，支持多学期成绩录入与加权计算　, tags: ["校园", "工具"] },
      { type: "file", name: "教务系统入口", url: "#", icon: "fa-university" },
      { type: "file", name: "图书馆检紀, url: "#", icon: "fa-book" },
...
export const waveData: FeatureItem[] = [
  {
    ...
    color: "text-amber-300",
    children: [
      { type: "file", name: "起点宣言：我们想成为什么样的大亀, url: "#", icon: "fa-quote-left" },
      { type: "file", name: "四年成长路线图：树成林计划草稀, url: "#", icon: "fa-road" },
  ...
  },
  {
    ...
    children: [
      ...
      { type: "file", name: "问与答：我们抛出的那些问颀, url: "#", icon: "fa-question-circle" },
    ],
  },
  {
    type: "folder",
    ...
    children: [
      ...
      { type: "file", name: "故事合集：他们的片段与转技, url: "#", icon: "fa-bookmark" },
  ...
  },
  {
    ...
    children: [
      ...
      { type: "file", name: "第一次交作业的夜晀, url: "#", icon: "fa-moon-o" },
      { type: "file", name: "差点想放弃的那个时刻", url: "#", icon: "fa-exclamation-circle" },
      { type: "file", name: "回望时最感谢的一件小亀, url: "#", icon: "fa-heart-o" },
    ],
  },
  {
    type: "folder",
    ...
    children: [
      ...
      { type: "file", name: "期末大战周：图书馆里的长夀, url: "#", icon: "fa-clock-o" },
      { type: "file", name: "实习与打工记：试着走进社会的你", url: "#", icon: "fa-briefcase" },
      { type: "file", name: "路上的风景：车窗外一闪而过的画靀, url: "#", icon: "fa-camera" },
    ],
  },
];
