...
export const portalCards = [
  { title: "我的知识库", href: "/features/notes", icon: "fa-book" },
  { title: "AIMFlly 应用", href: "#", icon: "fa-th-large" },
  { title: "一刻记忆", href: "/features/memory", icon: "fa-camera-retro" },
  { title: "AIMFlly 波纹", href: "#", icon: "fa-tint" },
  { title: "开源共享", href: "/features/share", icon: "fa-github" },
  { title: "启示录导航", href: "/features/revelation", icon: "fa-compass" },
] as const;
...
export const insightCards = [
  { title: "世界不死，理想不灭", body: "愿你始终保有对世界的热爱，对远方的好奇。", tone: "amber" },
  { title: "羽化成蝶，升生不息", body: "成长不是突变，而是持续迭代与重构。", tone: "cyan" },
  { title: "不问前程，尽管繁荣", body: "把每一个今天做到极致，就是对未来最好的回答。", tone: "violet" },
] as const;
