  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-2 gap-5">
        <StoryCard icon="fas fa-camera-retro text-5xl" caption="捕捉光影的瞬间" title="摄影 plus 剪辑 🎬" body="快门按下去的那一刻，画面只是素材；真正的故事在后期慢慢拼起来。剪辑带给我的快乐，是把「当时没来得及感受的情绪」重新拼回时间里。" />
        <StoryCard icon="fas fa-pen-nib text-5xl" caption="修仙之路的宁静" title="写作 ◎ 修仙 ✍️" body="相比于「一次性讲明白一个大道理」，我更喜欢写一些很日常、但回头看会微微心软的片段。修仙不一定要刀光剑影，可以是一杯热水、一封写给未来的信。" />
      </div>
