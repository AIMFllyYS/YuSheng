...
export function AboutSection({ openJourney }: { openJourney: () => void }) {
  ...
  const timeline = [
    ...
    { y: "2023", title: "2025 · 分岔跀, body: "开始认真思考「基因工程」「多组学」「AI」与自己的关系。读书会、活动策划、视频剪辑陆续上线　 },
  ...
  return (
    <>
      <div className="glass-card p-8 md:p-10 relative overflow-hidden mb-8">
        <div className="absolute -right-8 -top-8 text-[140px] opacity-[0.03] font-art pointer-events-none select-none" style={{ color: "var(--accent-main)" }}>羀</div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="space-y-5">
            <div>
              ...
              <div className="flex items-center space-x-2 text-sm"><i className="fas fa-map-marker-alt text-red-400" /><span>黑龙汀· 哈尔滀</span></div>
              <div className="flex items-center space-x-2 mt-1.5 text-gray-400 text-xs"><i className="fas fa-university" /><span>华中科技大学 · 基础医学陀</span></div>
            </div>
            <div>
          ...
          <div className="md:col-span-2 space-y-5 text-gray-300 text-sm leading-relaxed">
            <div><h4 className="font-bold text-white mb-1.5">何言 e/i？</h4><p>进行活动时基本上是最外向的，平时跟大家熟了可以很抽象 ₍₍ ฀*Ӧ)฀⁾⁾，也可以很严肃（｀へ´）。不过面对一些陌生人，尤其是在线下的时候，会突然切换成 i 人模式。所什MBTI 对我来说更像一个「观察自己状态」的小标签，而不是定论　</p></div>
