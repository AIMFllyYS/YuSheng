  ...
  return (
    <div className="glass-card p-8 md:p-10 relative overflow-hidden border-t-4" style={{ borderColor: "var(--accent-main)" }}>
      ...
      <div className="space-y-4 text-gray-300 leading-relaxed">
        ...
        <blockquote className="border-l-4 pl-5 italic text-lg text-white my-6 bg-white/5 p-5 rounded-r-xl" style={{ borderColor: "var(--accent-main)" }}>&quot;尽管繁华，不问前稀quot;</blockquote>
