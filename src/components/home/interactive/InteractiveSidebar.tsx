  ...
  return (
    <>
      <div className="glass-card p-6">
        <h3 className="text-xl font-bold mb-3 flex items-center"><i className="fas fa-chart-pie mr-2" style={{ color: "var(--accent-sub)" }} /> 偏好小投�?/h3>
      ...
      <div className="flex flex-col gap-5">
        <div className="glass-card p-5 text-center relative overflow-hidden group flex-1">
          ...
          <h3 className="text-lg font-bold mb-2">今日运势 · 幸运�?/h3>
